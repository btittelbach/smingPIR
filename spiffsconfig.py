...
def writeConfig(ip,nm,gw,wifi_ssid,wifi_pass,mqtt_broker,mqtt_clientid,mqtt_user,mqtt_pass,authtoken,dhcp=True,mqtt_port=1883,check_intervall=6000):
    ...
    CHECK_INTERVAL_SETTINGS_FILE = "checkinterval.conf"
    DIR="./files/"
    ...
    with open(os.path.join(DIR, CHECK_INTERVAL_SETTINGS_FILE),"wb") as fh:
        fh.write(struct.pack("<I",  int(check_intervall)))
